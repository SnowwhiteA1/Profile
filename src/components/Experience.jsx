export default function Experience() {
  return (
    <section className="mb-8">
      <h2 className="text-xl font-semibold text-black-500 mb-2 bg-gray-300 px-4 py-2 w-full block">Experience</h2>
      <p>Independent Developer & Researcher (2022-Present)</p>
